...
<div class="wrapper">
	...
	<div class="container" style="background-image:url('images/blank03.jpg');">
		...
		<div class="back">
<a href="party_packs.php" target="_parent" style="display:block; width:40px; background-color:#666666; color:#000000;">Back</a>		
<table width="800" align="center"><tr><td><img src="images/partypack02.jpg" height="400" width="500"></td></tr>
</table>
